...
const Video = (props) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row w-[98%] sm:w-[90%] sm:items-start gap-x-4 cursor-pointer">
      <img
        alt="Video Thumbnail"
      ...
      >
        <div className="w-[96%] lg:max-w-[850px] h-[240px] sm:h-[320px] lg:h-[430px] container">
          ...
          <div>
            ...
            <h2 className="text-md sm:text-xl md:text-2xl text-[#000000] font-medium">
